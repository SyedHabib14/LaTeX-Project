...
\title{Enhancing Decision-Making in Residential Projects: Fuzzy Multi-Criteria Sorting for Delay Analysis} % The article title

\author{
	\authorstyle{By Syed Habeeb Haider Zaidy\textsuperscript{1}}  % Authors
	\newline\newline % Space before institutions
	\textsuperscript{1}\institution{University of Management and Technology, Lahore}
}
...
\lettrineabstract{Making well-informed decisions is crucial when it comes to residential project management. This paper explores the advanced field of delay analysis and provides a thorough methodology to improve decision-making in residential projects. The use of a fuzzy multi-criteria sorting algorithm is the main focus of the study. This complex framework carefully takes into account the experience of experts, assessing important factors like cost, time, and quality. A careful analysis is conducted of the possibilities, which span from A1 to A5. This research aims to give stakeholders involved in residential project management a nuanced understanding and practical insights by utilizing a strong combination of techniques, such as Q-RUNG, CRITIC, and PROMETHEE.}

%----------------------------------------------------------------------------------------
%	ARTICLE CONTENTS
%----------------------------------------------------------------------------------------

\section{Criteria Framework}

The study aims to contribute to more effective decision-making in construction project management by providing a systematic and flexible approach to assess and prioritize the causes of delays.
